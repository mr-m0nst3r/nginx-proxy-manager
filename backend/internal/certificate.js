...
const internalCertificate = {
	...
	*/
	...
	requestLetsEncryptSslWithDnsChallenge: (certificate) => {
		...
		const prepareCmd = '. /opt/certbot/bin/activate && pip install -i https://pypi.tuna.tsinghua.edu.cn/simple/ --no-cache-dir --user ' + dns_plugin.package_name + (dns_plugin.version_requirement || '') + ' ' + dns_plugin.dependencies + ' && deactivate';
